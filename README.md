...
```bash
claude plugin marketplace add markhamsquareventures/learn-ai-with-nick-plugins
claude plugin install learn-ai-with-nick
```
...
Each skill is a markdown file that tells Claude Code what to do. After installing the plugin, run skills by name:
